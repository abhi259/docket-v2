      ...
      <div className="p-6 border-b border-gray-200">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 bg-gradient-to-br from-orange-500 to-red-600 rounded-2xl flex items-center justify-center shadow-lg shadow-orange-200">
            ...
            >
              {/* Top bun */}
              <path d="M4 11c0-3.5 3.5-6 8-6s8 2.5 8 6H4z"/>
              {/* Sesame seeds */}
              <ellipse cx="8" cy="8" rx="0.8" ry="0.4" fill="currentColor"/>
              <ellipse cx="12" cy="6.5" rx="0.8" ry="0.4" fill="currentColor"/>
              <ellipse cx="16" cy="8" rx="0.8" ry="0.4" fill="currentColor"/>
              {/* Lettuce */}
              <path d="M3 12.5c1.5 1 3-0.5 4.5 0.5s3-0.5 4.5 0.5 3-0.5 4.5 0.5 3-0.5 4.5 0.5"/>
              {/* Patty */}
              <rect x="4" y="14" width="16" height="3" rx="1.5"/>
              {/* Bottom bun */}
              <path d="M4 18h16c0 1.5-3.5 2.5-8 2.5S4 19.5 4 18z"/>
            </svg>
          </div>
          <div>
